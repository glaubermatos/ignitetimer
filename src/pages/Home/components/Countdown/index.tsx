...
export function Countdown() {
    const { activeCycle, activeCycleId, onMarkCurrentCycleAsFinished } = useContext(CyclesContext)
  ...
  }, [activeCycle, totalSeconds, activeCycleId, onMarkCurrentCycleAsFinished])
